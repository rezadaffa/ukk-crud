...
<html>
<head>
	<title>Booking Tiket Murah </title>
...
<body>
	<h1>Booking Tiket Murah</h1>
	<div class="main-agileinfo">
		<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item"><span>Tiketing Perjalanan</span></li>				
				</ul>			
					<div class="tab-1 resp-tab-content oneway">
						...
						<form action="<?php echo base_url('insert/tambah_aksi'); ?>" method="post">
							...
							<div class="clear"></div>
							<input type="submit" value="Kita Booking">
							<button type="hi"> <a href="duduk">DUDUK</a></button>
						</form>						
							</div>		
					</div>
				</div>						
	...
	<div class="footer-w3l">
		<p class="agileinfo"> &copy; 2018 Flight Ticket Booking . All Rights Reserved | Design by <a href="http://w3layouts.com">Sancexz</a></p>
	</div>
